...
class SockFlood:
	def __init__(self):
		os.system("cls")
		os.system("Evil Ddos-Attacker The Best Ddoser")
		self.host=None
		self.portnum=None
		self.threads=None
...
╚══════╝░░░╚═╝░░░╚═╝╚══════╝ 
		...
		print(Fore.YELLOW+"""
		[+] MADE BY PYTHON [+]"""+Fore.GREEN+"""
		[+] Developer : D1MOD [ """+Fore.WHITE+"""Zhyar ]""")
		print(Fore.WHITE+"""
	...
	def command_parser(self,command):
		if command=="help":
			print(Fore.WHITE+"""
	Welcome To Evil-Attacker Help Menu - 
	(+) Need (IP or HOSTNAME)
	(+) Need (Ports) Such As (443 ,8080) Default 80
	(+) Attack For Website Default 1000
	(+) D1MOD ATTACKING THE HOST AND SERVER.............
	""")
		if "host " in command:
